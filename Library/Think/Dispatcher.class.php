...
class Dispatcher
{
     ...
     * 查看模块是否存在及其加载配置文件
     */
    private static function checkMoudleExist()
    {
        // 检测模块是否存在
     ...
     * 检测是否定义了
     */
    private static function checkConstAPP($varPath)
    {
        if (defined('__APP__')) {
           return ;
        }
     ...
     * / 模块URL地址
     */
    private static function moudleURLAddress($varController, $varAction, $urlCase)
    {
        // 模块URL地址
     ...
     * 开启子域名部署
     */
    private static function openSubdomainDeployment()
    {
     ...
     * 分析pathinfo
     */
    private static function parsePathInfo($varModule)
    {
        // 分析PATHINFO信息
